    ...
    <div>
      ...
      <ol>
        ...
        <li>
          ...
          <p>
            If you don't find people to help you immediatly, just keep on doing
            circles around the cauldron killing dwarves, giants and greater lava
            spiders while waiting on people to join your group.
          </p>
        </li>
        <li>
          Once you got yourself a group (or at least one level 48+ partner). Go
          west to the Twilight camp at <em>(24,34)</em>. There is a cavern with{' '}
          <strong>Twilight mobs</strong> further to the west but don't go there,
          first you should go up a narrow path up the mountain. When you are up
          the path, you should face your first twilight mobs, they are all elite
          and lvl 48-50. Clear through them eastwards until you reach a small
          pool of lava. <em>(27,26)</em>
          <p>
        ...
        When you got both these items, you can say goodbye to your group and go
        back to Kalaran Windblade. You can also go to thorium point for a quick
        ...
        <li>
          Go southwest to the first watch tower <em>(33,52)</em>. Don't forget
          to kill any mob you might still need on the way (golem, spider, dark
          iron steamsmith or lookout)
          <p>
          ...
          <p>
            There is one elite Dark Iron Sentry on the tower, you don't need to
          ...
          <p>
            <img
              src="/assets/wp/sentrybrazier.jpg"
              alt=""
              className="bb-image"
            />
          </p>
          <p>
            It will be instantly lit. Then jump down and run away to lose aggro
            on the elite.
          </p>
          <p>
            Do exactly the same thing on the 2nd tower <em>(35,59)</em>, the 3rd
            tower <em>(43,63)</em> and the 4th tower accessible only through a
            bridge at <em>(52,57)</em>.
            <br />
            <em>Note:</em>
        ...
        <li>
          ...
          <p>
            ...
            If you feel like you are capable of soloing a level 48 Elite (green
        ...
        <li>
          Go back to Squire Maltrake <em>(38,39)</em>, turn in the quest and
          watch Kalaran transform into a dragon, make his speech and then he'll
          fly away. Righ tclick the treasure chest named{' '}
        ...
        <li>
          ...
          back to thorium point and turn them in.
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            <img src="/assets/wp/xpratesg.jpg" alt="" />
          </p>
          <p>
            <strong>Note:</strong>
            <br /> I had XP Bonus for the major part of the circuit, however if
            you do the math it's still around 30000 XP / hour.
          </p>
        ...
        <li>
          Resupply food/drink (4 stacks), then ride southwest to the slope going
          down to Ungoro Crater <em>(27,57)</em>.
          <p>
            <strong>Start of Un'goro Circuit #1</strong>
          </p>
          <p>
            <img src="/assets/wp/ungorocircuit1.jpg" alt="" />
          </p>
          <p>
            Go down the slope and find Torwa Pathfinder to the right up a small
            hill <em>(71,75)</em>. Get the 2 quests:
            <br />
          </p>
          <ul>
            <li>
        ...
        From now on, while in Ungoro Crater look around for crystals. There is 4
        types of crystals:
        <p>
          ...
          soils for 2 other quests which will require you to transmuate Un'goro
          soils into Morrowgrain.
        </p>
        <li>
