  ...
  return (
    <div>
      ...
      <ol>
        <li>
          <p>
            <strong>Go to Stormwind.</strong> Go to the Dwarven District and get
            the quest{' '}
            <span className="quest">[43] In Search of the Temple (Elite)</span>{' '}
        ...
        <li>
          ...
          <p>
            ...
            you find some Nagas. Kill <strong>Naga Explorers</strong> at{' '}
            <em>(24,65)</em> until you get{' '}
            <span className="item">10 Akiris Reed.</span>
          </p>
          <p>
            Then go back to the exit of Booty Bay but this time follow the trail
            to the north. A bit further on the right hand side of the road you
            will find <strong>Elder Mistvale Gorillas</strong> <em>(31,67)</em>.
            Kill Gorillas there until you get{' '}
            <span className="item">5 Mistvale Giblets</span>.
          </p>
        </li>
        <li>
          <p>
          ...
          <p>
            ...
            at First Mate Crazz a bit further towards the Inn. Get the follow
            up.{' '}
          </p>
          <p>
            Turn in <span className="quest">[43] Akiris by the Bundle</span> at
          ...
          <p>
            ...
            Deeg on the 2nd floor of the Inn. Get the follow up{' '}
            <span className="quest">[43] The Bloodsail Buccaneers</span> from
            Fleet Master Seahorn on the 2nd Floor of the Inn.
          </p>{' '}
          <p>
          ...
          <p>
            ...
            <span className="quest">
              <strong>[42] Keep an Eye out</strong>
            </span>{' '}
            from Dizzy One-Eye who stands to the right of the Booty Bay
            blacksmith house. (Left when entering Booty Bay from the tunnel).
          </p>
          <p>
            <em>
          ...
          <div>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/stv2c1xp.jpg"
              alt=""
            />
          </div>
          <p>
            <em>Note:</em> Of course, I had XP rest bonus this time. I
        ...
        <li>
          ...
          <p>
            ...
            <em>Wild Shore</em>. From there, go southwards while killing any{' '}
            <strong>Bloodsails</strong> on the way until you reach the 1st camp{' '}
            <em>(29,80)</em>.{' '}
          </p>
          <p>
          ...
          <p>
            ...
            their shadowbolts if you can, and kill them fast then deal with
            their pets. If you are Rogue or Mage though, I suggest sap /
            polymorph on the warlock first, kill the pet and then the warlock.{' '}
          </p>
          <p>
          ...
          <p>
            <ul>
              <li>
                {' '}
                <span className="item">10 Bloodsail Swashbuckler Kills</span>
              </li>
              <li>
                {' '}
                <span className="item">15 Snuff</span> (can drop from any
                Bloodsail)
              </li>
              <li>
                {' '}
          ...
          <p>
            <em>
              ** From this point on, if you find any{' '}
              <strong>Shadowmaw Panther</strong> (they are stealthed) make sure
              you kill them **
            </em>
          </p>
          <p>
            At <em>(39,41)</em> go east and you will find{' '}
            <strong>Venture Co. Goblins</strong> uphill. Kill them until you get{' '}
            <span className="item">10 Singing Blue Crystals</span>.{' '}
          </p>
          <p>
            Then go west to the other side of the road, you should find{' '}
            <strong>Jungle Stalkers</strong> <em>(34,37)</em>. Kill 10.{' '}
          </p>
          <p>
            Then go northeast to <em>(36,35)</em> and kill{' '}
          ...
          <p>
            Keep doing circles around that big hill and you will find 10
            panthers quickly. Kill anything on the way too while searching those
            panthers.{' '}
          </p>
          <p>
      ...
      <ol>
        <li>
          <p>
            ...
            and got all your tusks, get back on the main road and go north until
            you get to the <strong>Venture Co. Base</strong> at Lake Nezferiti,
            go to the Operations Center which looks like an oil rig platform{' '}
            <em>(42,18 )</em>.
          </p>
          <p>
            Go on top of it and kill <strong>Foreman Cozzle</strong>, loot his{' '}
            <span className="item">Key</span>. Jump down and go to the small
            house next to the lumber mill, open the chest and get the{' '}
            <span className="item">Fuel Regulator Blueprints</span>.
          </p>
          <p>
          ...
          <p>
            ...
            right, then take a u-turn to the right and go west until the last
            ruin <em>(23,11)</em>.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>Keep going east to Camp Nesingwary.</strong>{' '}
            <em>(35,10)</em> Turn in:
            <ul>
              <li>
                <span className="quest">
          ...
          <p>
            ...
            <ul>
              <li>
                <span className="quest">
                  <strong>[41] Venture Company Mining</strong>
                </span>{' '}
                at Crank Fizzlebub in the Booty Bay Inn.
              </li>
              <li>
                <span className="quest">
                  <strong>[42] Up to Snuff</strong>
                </span>{' '}
                at Deeg on the 2nd Floor of the Inn.
              </li>
              <li>
                <span className="quest">
                  <strong>[43] Skullsplitter Tusks</strong>
                </span>{' '}
                at Kebok, 2nd floor of the Inn.
              </li>
              <li>
                <span className="quest">
                  <strong>[37] Goblin Sponsorship</strong>
                </span>{' '}
        ...
        <div>
          <em>End of Circuit 2:</em>
        </div>
        <div>
          <img
            src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/stv2c2xp.jpg"
            alt=""
          />
        </div>
        <p>
          <em>Note:</em> I still had the darn XP rest bonus for the first 40000
          xp, so chalk off 20000 XP of the total score. This results in an XP
          Rate of 35000 XP/ Hour.
        </p>
        <li>
          <p>
            <strong>Fly to Stormwind City</strong>, go train, repair, sell,
            auction and restock food/drink up to 3 stacks.
          </p>
        </li>
        <li>
          <p>
        ...
        <div>
          <em>End of circuit 3:</em>
        </div>
        <div>
          <img
            src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/stv2c3xp.jpg"
            alt=""
          />
        </div>
        <div>
        ...
        <li>
          <p>
            <strong>Fly to Darkshire</strong> (Duskwood) From Darkshire go east,
            enter Deadwind Pass, go east through Deadwind Pass until you enter
            the Swamps of Sorrows.
          </p>
          <div>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/soscircuit.jpg"
              alt=""
            />
          </div>
          <p>
            When in Swamps of Sorrows go east to <strong>Watcher Biggs</strong>{' '}
            <em>(26,59)</em>, get quest{' '}
            <span className="quest">
              <strong>[37] Encroaching Wildlife</strong>
            </span>
            .
          </p>
          <p>
            You can find <strong>Spiders</strong>, <strong>Jaguars</strong> and{' '}
            <strong>Young Crocolisks</strong> in the whole area of swamps north
            of Watcher Biggs. Complete the quest and then go back to him, get
            the follow up{' '}
            <span className="quest">
              <strong>[35] The Lost Caravan</strong>
            </span>
            .
          </p>
          <p>
          ...
          <p>
            ...
            <span className="quest">
              <strong>[35] Draenethyst Crystals</strong>
            </span>{' '}
            from Magtoor.
          </p>
          <p>
          ...
          <p>
            You should let Galen go in front and get the first hits, you can
            also eat/drink when he is attacked by only one NPC. He regens back
            to full health after each fight.
          </p>
          <p>
          ...
          <p>
            Then go northwest to Magtoor at <em>(26,31)</em>. Turn in the two
            quests.
          </p>
          <p>
            Then go south to Watcher Biggs. Get the follow up{' '}
            <span className="quest">
              <strong>[42] Driftwood</strong>
            </span>
            .
          </p>
          <p>
            ...
            <span className="quest">
              <strong>[43] In Search of the Temple</strong>
            </span>
            .
          </p>
          <p>
            Then keep going east until you reach the shore. Search southwards
            along the shore for <strong>Sundried Driftwood</strong> (they look
            like wooden planks, lying on the sand), kill murlocs when they are
            in the way until you have{' '}
            <span className="item">8 Sundried Driftwood</span>.
          </p>
          <p>
          ...
          <p>
            Find the Gryphon Master and fly back to Stormwind. Repair, sell,
            check the auction house
          </p>
          <p>
            Go talk to Brohann Caskbelly in the Dwarven District and get the
            follow up{' '}
            <span className="quest">
              <strong>[43] To the Hinterlands</strong>
            </span>
            .
          </p>
          <p>
      ...
      <ol>
        <li>
          <p>
            <strong>Go to Ironforge</strong>, sell, repair, check the auction
            house.
          </p>
          <p>
            From Ironforge, fly to Menethil Harbor (Wetlands). Take the boat to
            Auberdine, this boat is at the northern peer.
          </p>
          <p>
            Once in Auberdine, get the flight path from the Hippogryph Master,
          ...
          <p>
            ...
            quest to become master in First Aid there. You need to have a skill
            225 and be level 40. Go talk to Doctor Gustaf VanHowzen in the
            Foothold Citadel and do the little quest where you have to bandage
            patients and get 3900 easy XP.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Ride back towards Gadgetzan</strong>, make a stop at
            Noonshade Ruins and kill <strong>bandits / thieves</strong> there
        ...
        <li>
          <p>
            <strong>Ride north to Thousand Needles</strong> and to the
          ...
          <p>
            ...
            blue question mark over the head. Start his quest, follow him, he
            will set up an explosive and distract Rizzle Brassbolt out of his
            house.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>Ride back to Gadgetzan</strong> and fly to Thalanaar
            (Feralas).
          </p>
          <p>
            In Feralas, ride west, follow the road, but carefully avoid Camp
            Mojache (by the north) or the guards will make a quick deal of you.
          </p>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            location. Sell and Repair, re-supply food and drink (3 stacks)
          </p>
        </li>
        <li>
          <p>
          ...
          <p>
            ...
            to the Solarsal ruins, kill <strong>Nagas</strong> until you have{' '}
            <span className="item">10 Hatecrest Naga Scales</span>.
          </p>
          <p>
          ...
          <p>
            Go south past the Ruins of Solarsol and across the water to the Isle
            of Dread. On the Isle of Dread, clear a path to the Cave at{' '}
            <em>(26,67)</em>.
          </p>
          <p>
      ...
      <ol>
        <li>
          <p>
            ...
            <span className="item">Mysterious Relic</span> from him.
          </p>
          <p>
          ...
          <div>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/xpratefera1.jpg"
              alt=""
            />
          </div>
          <p>
        ...
        <li>
          ...
          <div>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/feralascircuit1.jpg"
              alt=""
            />
          </div>
        </li>
        <li>
          <p>
            Go east across the sea, back to Feralas[/b], follow the road east
            until you reach Ruins of Isildien <em>(61,53)</em>.
          </p>
          <p>
        ...
        <li>
          <p>
            ...
            <span className="item">Hippogryph Eggs</span> on the floor at{' '}
          ...
          <p>
            ...
            <span className="item">10 Thick Yeti Hides</span>.
          </p>
          <p>
        ...
        <li>
          <p>
            <strong>Go back to Feralas</strong>, follow the main road east until{' '}
            <em>(71,48)</em> you should be directly north of the small lake.
          </p>
          <p>
            ...
            <span className="item">Large Leather Backpack</span> hanging at the
            trunk of that huge tree. Click it and get the follow up quest{' '}
            <span className="quest">[46] The Writhing Deep</span>.
          </p>{' '}
          <p>
        ...
        <li>
          <p>
            <strong>Go further south</strong> to the Writhing Deep and find the
            hole at <em>(74,63)</em>, go down the spiralling ramp until you
            reach the bottom.
          </p>
          <p>
            There enter the tunnel towards the west, inside the tunnel at the
        ...
        <li>
          <p>
            <strong>Go inside Darnassus</strong> (for those who never went
            there, you have to step in the pink haze at <em>(56,90)</em>)
          </p>
          <p>
            Inside Darnassus, go to the Temple of the Moon. Turn in the 2 quests
            there.
          </p>
          <p>
            While you are in Darnassus, go to your class trainer (if you are
            Warlock or Paladin, you will have to go to Auberdine and take the
            boat to Menethil Harbor then fly to Ironforge. Mages can just go
            learn the Portal to Darnassus and warp to a big city to train).
          </p>
      ...
      <ol>
        <li>
          <p>
            From Feathermoon, <strong>fly to Thalanaar</strong>.
          </p>
          <p>
            Turn in the quest{' '}
            <span className="quest">
          ...
          <p>
            ...
            <span className="quest">
              <strong>[48] The Borrower</strong>
            </span>{' '}
            at Curgle Cranklehop, get the follow up{' '}
            <span className="quest">
              <strong>[48] The Super Snapper FX (Elite)</strong>
            </span>
            .
          </p>
          <p>
            Right next to Curgle, click on the <strong>Egg-O-Matic</strong>.
            Complete the quest and you will get an{' '}
            <span className="item">Egg Crate</span>, open it then talk to Curgle
            again and complete the quest corresponding to the egg you got.
          </p>{' '}
          <p>Sell, Repair, get up to 3 Stacks of Food/Drink.</p>
        </li>
        <li>
          <p>
            In Tanaris ride to the southeast until you reach{' '}
            <strong>Waterspring Field</strong> <em>(63,37)</em>. You will find
          ...
          <p>
            ...
            between the tower structures, so you should go kill from a tower
        ...
        <li>
          ...
          <p>
            Go through this tunnel. Now you have a lot of work to do, check the
            kill list of{' '}
            <span className="quest">
              <strong>[45] Southsea Shakedown</strong>
            </span>{' '}
            and start killing <strong>Pirates</strong>!<br />
            Clear your way south toward the main camp with the 3 houses , 2
            ships ashore and the boat under construction.
          </p>
          <p>
            <strong>Andre Firebeard</strong> spawns at the campfire right in the
            center of the camp. He has 3 Dock Workers close to him but you can
            pull those 3 without him if you pull the back one, then you have
            Andre solo. Or you can burn him down fast and run away (or take them
            all).
          </p>
          <p>
          ...
          <p>
            <em>
              Bonus: There is a rare spawn named <strong>Kregg Keelhaul</strong>{' '}
        ...
        <li>
          <p>
            When done, get out of Rigger Cove and go north to Steamwheedle Port.
            Turn in:
            <ul>
              <li>
                <span className="quest">[45] Andre Firebeard</span>
              </li>
              <li>
                <span className="quest">[45] Southsea Shakedown</span>
              </li>
        ...
        <p>
          ...
          <span className="item">5 Wastewander Water Pouch</span> at Spigot
          Operator Luglunket (he has a blue question mark overhead)
        </p>
        <p>
          If you are not level 46 at this point, go grind on{' '}
          <strong>pirates</strong> until you hit 46.
        </p>
        <div>XP rate:</div>
        <div>
          <img
            src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/tanarisxp.jpg"
            alt=""
          />
        </div>
        <p>
      ...
      <ol>
        <li>
          <p>
            <strong>Go to Ironforge</strong> (Fly to Theramore, take the boat to
            Menethil Harbor and then fly to Ironforge) In Ironforge: Visit your
            class trainer, sell, repair, check auction house.
          </p>
          <p>
            <em>
            ...
            <span className="quest">[47] The Platinum Discs</span> quest, then
            go to the <strong>Hall of Explorers</strong>, talk to High Explorer
            Magellas, get the quest{' '}
            <span className="quest">[50] Portents of Uldum</span>, then talk to
            Historian Karnik further inside the Hall of Explorers and get the
            follow up <span className="quest">[50] Seeing what Happens</span>.
          </p>
          <p>
            Fly to <strong>Southshore</strong>, then go northeast to{' '}
            <strong>the Hinterlands</strong> <em>(84,32)</em>.
          </p>
          <p>
            ...
            <ul>
              ...
              <li>
                <span className="quest">[48] Skulk Rock Clean-up</span>
              </li>
            </ul>
          </p>
          <p>
            Turn in <span className="quest">[43] To the Hinterlands</span> at{' '}
            <strong>Falstad Wildhammer</strong> and get the follow up:{' '}
            <span className="quest">[43] Gryphon Master Talonaxe</span>
          </p>
          <p>
            On your way up to the top get the flight path for Aerie Peak. Talk
            to <strong>Gryphon Master Talonaxe</strong> and get the follow up:
            <ul>
              <li>
                <span className="quest">[43] Rhapsody Shindigger</span>. Also
                get{' '}
              </li>
              <li>
                <span className="quest">[45] Witherbark Cages</span> from him.
              </li>
            </ul>
          </p>
          <p>
            Then make Aerie Peak your home location. The innkeeper wanders about
            on the top floor inside the inn.
          </p>
          <p>
            <em>
              ** Reminder: If you find a{' '}
              <span className="item">distress beacon</span> on mobs in
              Hinterlands, right click it and get the quest**
            </em>
          </p>
          <p>
            <em>
          ...
          <div>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/hintercircuit1.jpg"
              alt=""
            />
          </div>
        </li>
        ...
        <li>
          <p>
            <em>Optional:</em> If you got the{' '}
            <span className="item">Distress Beacon OOX-22/HL</span>, go to the
            lake northwest of Skulk Rock and find the Homing robot there{' '}
            <em>(49,37)</em>. Turn in the quest. Before you accept the rescue
            quest, here is what you must know:
          </p>
          <ul>
            <li>
        ...
        <li>
          <p>
            Go southeast, to the <strong>Overlook Cliffs</strong>
            <em>(70,63)</em> and follow the path down to the shore.
          </p>
          <p>
            Search your bags for the{' '}
            <span className="item">Super Snapper FX</span> and make a hotkey out
            of it. Then ride along the shore and search for a named turtle named{' '}
        ...
        <li>
          <p>
            Hearthstone <strong>back to Aerie Peak</strong>.
          </p>
          <p>
            Turn in the quests:
            <ul>
          ...
          <p>
            <em>Optional:</em> You can turn in more Troll Necklaces at the same
            NPC if you have extra stacks of 5. You gain 390 XP and extra faction
          ...
          <p>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/hintercircuit1xp.jpg"
              alt=""
            />
          </p>
          <p>Sell, repair, buy up to 3 stacks food/drink.</p>
        </li>
        <li>
          <p>
          ...
          <p>
            ...
            <span className="item">Wildkin Feather</span> gathering. (You need
            15 feathers)
          </p>
          <p>
            You and two level 50s should be just enough to kill the 2 NPCs on
            top of the Altar of Zul. More will make it easier of course. I even
            managed to do it with just me (lvl 47 rogue) and a level 48 priest.
          ...
          <p>
            Say goodbye to your group and grind on trolls (you choose which
            camp) until you are one bubble away from <em>level 47</em>.
          </p>
          <p>
            <strong>
              <em>Optional:</em>
        ...
        <li>
          <p>
            Fly to <strong>Ironforge</strong>.
          </p>{' '}
          <p>
      ...
      <ol>
        <li>
          <p>
            ...
            <strong>Feathermoon Stronghold</strong>.
          </p>
          <p>
          ...
          <div>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/feralascircuit2.jpg"
              alt=""
            />
          </div>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            <span className="item">Miniaturization Residue</span> and 10{' '}
            <span className="item">Water Elemental Core</span>. Once finished,
            go turn in your quest at{' '}
        ...
        <li>
          <p>
            Get <strong>back on the main road</strong> and ride north/northeast
            towards the yeti cave <em>(51,32)</em>.
          </p>
          <p>
          ...
          <p>
            Kill <strong>Rage Scar Yetis</strong> until you get{' '}
            <span className="item">10 Rage Scar Yeti Hide</span> and a{' '}
            <span className="item">Pristine Yeti Hide</span>{' '}
            <em>(rare drop)</em>. When you get the Pristine hide, right click it
            and get the quest.
          </p>
          <p>
            <em>Note:</em> Miners / Skinners you might want to grind here a
            little, this is a good spot.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            <span className="item">Samha Essence</span>.
          </p>
          <p>
            ...
            <span className="item">Imbel Essence</span>.
          </p>
          <p>
            Then go southwest (ignore Shay Leafrunner for now if you see her)
            until <span className="item">(37,11)</span>. The Flame of Lahassa is
            under a dark brown gazebo. Loot the{' '}
            <span className="item">Lahassa Essence</span>.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            Once at the giant, turn in the quest. Then go southeast and back on
            the road, follow the road south and then east until <em>(54,41)</em>
            .
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            advice, just <strong>ALWAYS</strong> let the chicken get hit first
        ...
        <li>
          <p>
            Then get <strong>back on the road</strong>, keep going east and past
            the bridge until <em>(65,49)</em>.
          </p>
          <p>
        ...
        <li>
          <p>
            Fly to <strong>Thalanaar</strong> and then to{' '}
        ...
        <div>
          <img
            src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/tanariscircuit1.jpg"
            alt=""
          />
          <img
            src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/tanariscircuit1info.jpg"
            alt=""
          />
        </div>
        <li>
          <p>
            Get out of Gadgetzan and <strong>go south</strong> until you find
            the skeletal remains of some huge animal <em>(50,35)</em>.
          </p>{' '}
          <p>
        ...
        <li>
          <p>
            Go <strong>northwest</strong> to the pool of water by the Sandsorrow
            watch <em>(38,29)</em>.
          </p>
          <p>
      ...
      <ol>
        <li>
          <p>
            ...
            <span className="quest">[47] The Platinum Discs</span>, go southwest
            to Uldum <strong>(38,79)</strong>. The Dune Smashers have a small
            aggro range, you can hug the left wall and reach the Stone Watcher
            of Norgannon, just be careful of the one roamer.{' '}
          </p>
          <p>
            <strong>The Stone Watcher of Norgannon</strong> is at{' '}
            <em>(37,81)</em>. Click the <strong>Uldum Pedestal</strong> under
            him and get the follow up, then talk to the Stone Watcher of
            Norgannon who just appeared on the pedestal. Go through his dialogue
            and you will complete the follow up. Then click the Uldum pedestal
            again, complete the quest and get the follow up{' '}
            <span className="quest">
        ...
        <li>
          <p>
            ...
            <strong>Thistleshrub Valley</strong> <em>(28,67)</em>. Kill{' '}
            <strong>Gnarled Thistleshrubs</strong> and{' '}
            <strong>Thistleshrub Rootshapers</strong> until you get 8 kills of
            each. Also kill <strong>Thistleshrub Dew Collectors</strong> until a{' '}
            <span className="item">Laden Dew Gland</span> drops{' '}
            <em>(rare drop)</em>.
          </p>
        </li>
        <li>
          <p>
            Go north to the <strong>Noxious Lair</strong> <em>(31,51)</em>. Kill{' '}
            <strong>Centipaars</strong> there, <strong>Stingers</strong>,{' '}
            <strong>Wasps</strong>, <strong>Tunnelers</strong>.. until you get{' '}
            <span className="item">5 Centipaar Insect Parts</span>. Then go back
            to Gadgetzan.
          </p>
        </li>
        <li>
          <p>
            ...
            <ul>
              <li>
                <span className="quest">
                  <strong>[49] The Thirsty Goblin</strong>
                </span>{' '}
                at Marin Noggenfogger. Get the follow up{' '}
                <span className="quest">
                  <strong>[49] In Good Taste</strong>
                </span>
                .
              </li>
              <li>
              ...
              <li>
                <span className="quest">
                  <strong>[49] In Good Taste at Sprinkle</strong>
                </span>
                , get the follow up{' '}
                <span className="quest">
              ...
              <li>
                <span className="quest">
                  <strong>[47] Noxious Lair Investigation</strong>
                </span>{' '}
        ...
        <li>
          <p>
            Get the quest:
            <span className="quest">[48] The Scrimshank Redemption</span> from
          ...
          <p>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/tanariscircuit1xp.jpg"
              alt=""
            />
          </p>
        </li>
        <li>
          <p>Sell/repair/restock food-drink (3 stacks).</p>
        </li>
        <li>
          <p>
          ...
          <p>
            Go further south to the <strong>Gaping Chasm</strong>
            <em>(56,61)</em>, clear yourself a path through the insects
            southwards until you find the entrance spiralling down at{' '}
            <em>(55,70)</em>.
          </p>
          <p>
            Take the 2nd tunnel you see when going down the spiral, the one
            going north <em>(55,69)</em>.
          </p>
          <p>
            Inside the tunnel at the first fork go right. Then go through the
            circular room.
          </p>
          <p>
          ...
          <p>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/scrimshankgear.jpg"
              alt=""
            />
          </p>
          <p>
            Loot it and then go back the way you came from, and then go north
            until you are out of the Gaping Chasm.
          </p>
        </li>
        <li>
          <p>
          ...
          <p>
            If you do have the Distress Beacon for Tanaris: Go east and inside
            the mountain at <em>(60,64)</em>. You will find the{' '}
          ...
          <p>
            ...
            <ol>
              <li>
                Let the chicken in front, let him get hit first. Sometimes mobs
                will aggro him but not manage to hit him while he walks and they
                will just give up.
              </li>
              <li>
                The first part of the escort is the hardest as you will run into
                lvl 46-47 mobs. And at some point you will get an ambush of 3
                level 46 scorpions. Use your long cooldown abilities there.
                After this, it gets easier.
              </li>
              <li>
                Later on you will get a 2nd ambush, 3 humanoids lvl 42 (green).
                One will be a shadow mage though, kill it first.
              </li>
            </ol>
          </p>
        </li>
        <li>
          <p>
            Ride back to Gadgetzan, talk to Senior Surveyor Fizzledowser and get
            the follow up{' '}
            <span className="quest">[48] Insect Part Analysis</span>.
          </p>
          <p>
            Go talk to Alchemist Pestlezugg, get the follow up and get back to
            Surveyor Fizzledowser. Turn in the quest and get the follow up{' '}
            <span className="quest">[49] Rise of the Slithid</span>.
          </p>
          <p>
            Get your 2 <span className="item">Elixir of Fortitude</span> from
            the bank in Gadgetzan. Then ride north to the thousand needles.
          </p>
        </li>
        <li>
          <p>
            Go to the <strong>Mirage Raceway</strong> and talk to Quentin{' '}
            <em>(78,74)</em>. Turn in the quest{' '}
            <span className="quest">
              <strong>[47] An Orphan Looking for a Home</strong>
            </span>
            . Get the follow up, turn it in instantly (as you already have the 2{' '}
            <span className="item">Elixir of Fortitude</span>).
          </p>
          <p>
            Get the quest{' '}
            <span className="quest">[47] The Newest Member of the Family</span>{' '}
            and hearthstone to <strong>Aerie Peak</strong>. Go talk to Agnar
            Beastamer, he is inside the inn on the lower level. Turn in{' '}
            <span className="quest">[47] The Newest Member of the Family</span>.
            Get the follow up <span className="quest">[47] Food for Baby</span>.
          </p>
          <p>
            <em>
              <strong>End of Circuit</strong>
        ...
        <li>
          ...
          <p>
            ...
            <strong>Silvermane Stalkers</strong>. They are level 47-48 wolves
            and they are stealthed. Run circles in the area I described among
            the trees, hit tab while looking around.
          </p>
          <p>
            You should find them quickly, they drop the stuff you need 40% of
            the time. (Humans: use perception / Warlocks: Buff yourself with
            detect invisibility) Kill everything on your way while you are at
            it, like those goofy looking Owlbeasts.
          </p>
        </li>
        <li>
          <p>
            Once you got 5 x{' '}
            <span className="item">Silvermane Stalker Flank</span>, ride west to{' '}
            <strong>Valorwind Lake</strong> at <em>(40,60)</em>.
          </p>
          <p>
          ...
          <p>
            ...
            Turn in the quest{' '}
            <span className="quest">
              <strong>[47] Food for Baby</strong>
            </span>{' '}
            and get the follow up{' '}
            <span className="quest">
        ...
        <li>
          ...
          <p>
            <em>
              If you went to Uldaman before and if you did the platinum discs
              quest:
            </em>
          </p>
          <p>
            Go to the Halls of Explorer, turn in{' '}
            <span className="quest">[50] Return to Ironforge</span> at Historian
            Karnik and
            <br /> get the follow up{' '}
            <span className="quest">[50] A Future Task</span>
            .<br />
            Also get <span className="quest">[52] Passing the Burden</span> from
            him.
            <br />
            Turn in <span className="quest">[50] A Future Task</span> at High
            Explorer Magellas. (yet another 4700 XP and 2 Gold 20 Silver.)
          </p>
          <p>
            <em>Note:</em> This is why I really advise doing certain instances.
            They are not a waste of time at all if you do them the right way.
            Here we got 3 times 4700XP only because we did a quest in Uldaman
            back then.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            You can also skip Gahz Ridian actually, but if you get someone in
            your group with the Mallet, you might as well go for it. Just make
        ...
        <li>
          ...
          <p>
            ...
            <strong>Harpies</strong> (good for Darkmoon Faire Tickets). You can
            also grind on <strong>ogres</strong> in Tanaris if you prefer.
          </p>
        </li>
        <li>
          <p>
          ...
          <p>
            ...
            the follow up <span className="quest">[49] Delivery for Marin</span>
            .
          </p>
          <p>
            Go talk to <strong>Marin Noggenfogger</strong> and get the follow up{' '}
            <span className="quest">[49] Noggenfogger Elixir</span> and turn it
            in. The elixirs are more fun than useful but sometimes they give
            nifty effects like levitation or water breathing, which can be
            helpful situationaly. Plus now you can buy Elixirs from Marin at
            will{' '}
            <span role="img" aria-label="smile">
              🙂
            </span>
      ...
      <ol>
        ...
        <li>
          <p>
            Ride out of Nethergarde Keep, go <strong>west / northwest</strong>{' '}
            until you find the two Blood Elves at <em>(50,14)</em>. Get all
            their quests:
            <ul>
              <li>
          ...
          <p>
            Start killing directly from here, you can find all the animals you
            need to kill for theses quests in the upper part of Blasted Lands.
          </p>
          <p>
            Avoid the area around the Dark Portal and the Tainted Scar. Avoid
            anything that is level 52 or above. Kill pretty much everything on
            your way until you have all the quests completed.{' '}
          </p>
          <p>
          ...
          <p>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/blastedlandscircuit1.jpg"
              alt=""
            />
          </p>
          <p>
            Completing all the quests will take a while, but here are a few
            tips:
            <ul>
              <li>
          ...
          <p>
            These buffs will help you killing faster, they do not stack, so wait
            for them to fade before you get the next one. Make good use of them{' '}
            <span role="img" aria-label="smile">
              🙂
            </span>
          </p>
        ...
        <li>
          <p>
            Hearthstone to <strong>Ironforge</strong> (or to Hinterlands if you
          ...
          <p>
            ...
            <ul>
              <li>
                <span className="quest">
                  <strong>[50] The Ancient Egg (Elite)</strong>
                </span>{' '}
                and
              </li>
              <li>
        ...
        <li>
          ...
          <p>
            ...
            Follow this path to find the Ancient Egg:
          </p>
          <p>
            <img
              src="https://web.archive.org/web/20101208214225im_/http://www.wow-pro.com/guidepics/jintha1.jpg"
              alt=""
            />
          </p>
          <p>
          ...
          <p>
            ...
            out of the cave back to the Altar, from there go north towards the
          ...
          <p>
            Go turn{' '}
            <span className="quest">
              <strong>[50] The Ancient Egg</strong>
            </span>{' '}
            in Tanaris at Steamwheedle port, and get the follow up quest{' '}
            <span className="quest">
              <strong>[53] The God Hakkar (Dungeon)</strong>
            </span>
          </p>
        </li>
        <li>
