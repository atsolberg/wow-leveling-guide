...
function Chapter3() {
  return (
    <div>
      ...
      <h3>Introduction:</h3>
      <div className="content clearfix node-content">
        <p>
          This guide starts at <span className="em">level 50</span>, it is the
          3rd chapter of my guide. Before starting I suggest you read the
          introduction and recommendations of my{' '}
          <a href="http://www.wow-pro.com/node/600" className="bb-url">
            1st Chapter
          </a>
          . If you are already level 50+ and just found this guide, I suggest
          you start at some point in the{' '}
          <a href="http://www.wow-pro.com/node/601" className="bb-url">
            Chapter II
          </a>{' '}
          so you get the following quests, which we will be doing in this
          chapter: <br />
        </p>
        <ul className="bb-list">
          <li>
            <span className="quest">
              <span className="strong">[49] Rise of the Silithid</span>
            </span>
          </li>
          <li>
            <span className="quest">
          ...
          <li>
            <span className="quest">
              <span className="strong">[53] The God Hakkar (Dungeon)</span>
            </span>
          </li>
        </ul>
        ...
        <p>
          <span className="small">
            <span className="strong">Shopping List</span>
          </span>
          <br />
        </p>
        <ul className="bb-list">
          ...
          <li>
            ...
            levels, the more we will go for long xp circuits far from any
            vendor. At level 60 when you will go farm money or anything, it will
            also be very handy to have a lot of bag space. Why only 3 traveller
            backpacks and not 4? Because at level 60 you will do a long quest
            line named{' '}
            <span className="strong">
              <span className="quest">
        ...
        <ol className="bb-list">
          <li>
            Go To <span className="strong">Maraudon</span>,{' '}
            <a href="http://www.wow-pro.com/node/594" className="bb-url">
          ...
          <li>
            ...
            <p>
              ...
              <span className="em">In details:</span> From Ironforge, fly to
              Thelsamar, then go south to Badlands. In Badlands you can find the
              entrance to the Searing Gorge on the western end of the Badlands,
              south of Kargath (the horde outpost) at{' '}
              <span className="em">(3,61)</span>
            </p>
            ...
            <p>
              ...
              then talk to Kalaran again and go through his dialogue. Turn in
              the quest and get the follow up{' '}
              <span className="quest">
                <span className="strong">[48] The Flawless Flame</span>
              </span>
              .
            </p>
            <p>
            ...
            <p>
              ...
              <span className="em">(37,26)</span>. Right click it and get the
              quests:
              <br />
            </p>
            <ul className="bb-list">
            ...
            <ul className="bb-list">
              ...
              <li>
                <span className="quest">
                  <span className="strong">[49] Curse These Fat Fingers</span>
                </span>
              </li>
              <li>
                <span className="quest">
                  <span className="strong">[49] Fiery Menace!</span>
                </span>
              </li>
            </ul>
          </li>
          ...
          <p>
            <span className="strong">Get the flight path.</span>
          </p>
          ...
          <li>
            ...
            actually looks like some public toilet. Right click it and get the
            quest{' '}
            <span className="quest">
          ...
          <li>
            ...
            northern part. Get full HP/Mana and get the quest from Dorius
            Stonetender{' '}
            <span className="quest">
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/dariusscroll.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            <p>
              ...
              <span className="quest">
                <span className="strong">[48] Suntar Stones</span>
              </span>
              .
            </p>
            <p></p>
          ...
          <li>
            ...
            <span className="strong">The Blazing Elementals</span> and the{' '}
          ...
          <li>
            ...
            <p>
              ...
              run for the scroll and loot it fast, then jump down the ledge
              behind the scroll.
            </p>
            <p>
            ...
            <p>
              Or warrior: charge the Taskmaster, and use intimidating shout.
              Loot the scroll quickly and jump down.
            </p>
            <p>
          ...
          <li>
            ...
            and go north to Karalan Windblade{' '}
            <span className="em">(39,38)</span>. Turn in the quest and get the
            follow up{' '}
            <span className="quest">
          ...
          <li>
            ...
            <p>
              ...
              <span className="strong">dark iron dwarves</span> in the slag pit
              for exemple to catch up.
              <br />
            </p>
          </li>
        </ol>
        ...
        <ol className="bb-list">
          ...
          <li>
            ...
            but never going down in it. Kill every{' '}
            <span className="strong">dwarf</span> and{' '}
            ...
            <p>
              ...
              <span className="strong">Dark Iron Lookouts</span> you can find at
          ...
          <li>
            ...
            <p>
              ...
              any dark iron dwarf, it generally takes me a full turn around the
          ...
          <li>
            ...
            <p>
              <span className="em">
                So first you must pull the mobs one by one and then the
                idolaters
              </span>
              . Once you go the lava pool cleared, you can go get the quest from
              that captured elf,{' '}
              <span className="strong">Zameal Lunthistle</span>. After taking
              his quest, talk to him again and go through his dialogue, then
              turn in the quest and get the follow up:{' '}
              <span className="quest">
                <span className="strong">[50] Prayer to Elune</span>
              </span>
              .
            </p>
            <p></p>
          ...
          <li>
            ...
            <span className="strong">Twilight mobs</span> (any of them) until
            you get :
            <ul className="bb-list">
              <li>
                <span className="item">Symbol of Ragnaros</span>
              </li>
              <li>
                <span className="item">Prayer to Elune</span>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <span className="quest">
              <span className="strong">[50] The Torh of Retribution</span>
            </span>
            . Turn it in, watch him craft the torch, then get the quest{' '}
            <span className="quest">
              <span className="strong">[50] The Torch of Retribution</span>
            </span>
            . Right click the stick surrounded by a green aura, complete the
            quest. Talk to Kalaran again, get the quest{' '}
            <span className="quest">
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[52] Set Them Ablaze! (Elite)</span>
              </span>
            </p>
          ...
          <li>
            ...
            <p>
              ...
              <span className="strong">Torch of Retribution</span> in your
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/sentrybrazier.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            <p>
              It will be instantly lit. Then jump down and run away to lose
              aggro on the elite.
            </p>
            <p>
              Do exactly the same thing on the 2nd tower{' '}
              <span className="em">(35,59)</span>, the 3rd tower{' '}
              <span className="em">(43,63)</span> and the 4th tower accessible
              only through a bridge at <span className="em">(52,57)</span>.
              <br />
              <span className="em">
                <br />
                Note:
          ...
          <li>
            ...
            <p>
              ...
              If you feel like you are capable of soloing a level 48 Elite
              (green for you at lvl 51), or if you are not solo, from the
              grimsite camp go south and find a narrow path going up the
          ...
          <li>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[48] Proof of Deed</span>
              </span>{' '}
              and{' '}
              <span className="quest">
                <span className="strong">[48] Suntara Stones</span>
          ...
          <li>
            ...
            <span className="quest">
              <span className="strong">[52] Arcane Runes</span>
            </span>{' '}
            from Tymor, also get{' '}
            <span className="quest">
            ...
            <ul className="bb-list">
              ...
              <li>
                <span className="quest">
                  <span className="strong">[53] March of the Silithid</span>
                </span>
              </li>
              <li>
                <span className="quest">
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/ungorocircuit1.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            <p>
              Go down the slope and find Torwa Pathfinder to the right up a
              small hill <span className="em">(71,75)</span>. Get the 2 quests:
              <br />
            </p>
            <ul className="bb-list">
              <li>
          ...
          <li>
            ...
            crystals until the following 2 goals are reached:
            <ul className="bb-list">
              <li>
                <span className="em">
              ...
              <li>
                <span className="item">7 Power Crystals of each color</span>
              </li>
            </ul>
          </li>
        </ol>
        ...
        <ol className="bb-list">
          <li>
            ...
            <ul className="bb-list">
              <li>
                <span className="quest">
                  <span className="strong">[52] Chasing A-Me 01</span>
                </span>
              </li>
              <li>
                <span className="quest">
              ...
              <li>
                <span className="quest">
                  <span className="strong">[55] Beware of Pterrordax</span>
                </span>{' '}
                from the Wanted Poster next to Spraggle Frock.
              </li>
              <li>
                <span className="quest">
                  <span className="strong">[51] Roll the Bones</span>
                </span>{' '}
                from Spark Nilminer
              </li>
            </ul>
          ...
          <p>
            ...
            and get{' '}
            <span className="quest">
              <span className="strong">[53] Expedition Salvation</span>
            </span>{' '}
          ...
          <li>
            ...
            <p>
              Get her quest{' '}
              <span className="quest">
                <span className="strong">[53] Crystals of Power</span>
              </span>{' '}
            ...
            <ul className="bb-list">
              <li>
                <span className="quest">
                  <span className="strong">[53] The Eastern Pylon</span>
                </span>
              </li>
              <li>
                <span className="quest">
                  <span className="strong">[53] The Northern Pylon</span>
                </span>
              </li>
              <li>
                <span className="quest">
                  <span className="strong">[53] The Western Pylon</span>
                </span>
              </li>
            </ul>
          </li>
          ...
          <p>
            <span className="em">Your quest log should look like this:</span>
          </p>
          ...
          <li>
            ...
            <ul className="bb-list">
              ...
              <li>
                <span className="strong">Pterrordaxes</span>
              </li>
              <li>
                <span className="strong">Diametradons</span>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <span className="strong">Tar Creepers</span> and{' '}
          ...
          <li>
            ...
            <p>
              ...
              <span className="em">(44,87)</span>, kill them. Stay at this spot
          ...
          <li>
            ...
            <p>
              ...
              , go out and kill some more flowers until you complete it. Go to
              the area which is southeast of the black pools where we killed the
              Tar beasts. There are plenty there and they are the easiest
              flowers to kill <span className="em">(65,27)</span>.
            </p>
            <p>
              Also make a stop at the{' '}
              <span className="strong">Northern Crystal Pylon</span>
          ...
          <li>
            ...
            <ul className="bb-list">
              ...
              <li>
                ...
                , Get the follow up{' '}
                <span className="quest">
                  <span className="strong">[52] A Visit to Gregan</span>
                </span>
              </li>
              <li>
                <span className="quest">
              ...
              <li>
                ...
                <span className="quest">
                  <span className="strong">[53] Making Sense of it</span>
                </span>{' '}
                from J.D. Collie. Turn it in. You can bank the book you get as
                reward from this quest (it tells you how to combine crystals at
                the various pylons for some consumable crystals with effects
                like heals or damage shields, but nothing so great, so just bank
                the book to have more bagspace).
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <p>
              In Gadgetzan, turn in{' '}
              <span className="quest">
                <span className="strong">[54] Super Sticky</span>
              </span>{' '}
              and{' '}
              <span className="quest">
                <span className="strong">[53] Bungle in the Jungle</span>
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/ungorocircuit1xp.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[50] Morrowgrain Research</span>
              </span>{' '}
              from Arch Druid Fandral Staghelm. A floor below get the follow up
              from Mathrengyl Bearwalker.
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/azsharacircuit.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <span className="strong">Haldarr Encampment</span>, kill{' '}
            <span className="strong">satyrs</span> there until you have{' '}
            <span className="quest">
        ...
        <ol className="bb-list">
          ...
          <li>
            ...
            <p>
              ...
              <span className="em">(39,55)</span>, get the rubbing.
            </p>
            <p>
            ...
            <p>
              ...
              the path leading to the Shattered Strand at{' '}
              <span className="em">(45,47)</span>. Consider this as a mini
              grinding session, because these nagas go down easily and there is
          ...
          <li>
            ...
            <p>
              ...
              inventory. After a few seconds a gyrocopter will land and Pilot
              Xiggs will come out, turn in the quest{' '}
              <span className="quest">
                <span className="strong">[52] Arcane Runes</span>
              </span>{' '}
          ...
          <li>
            ...
            <p>
              In Felwood, stay on the road until you see an elf to the right
              named Arathandris Silversky <span className="em">(54,86)</span>.
              Get the quest{' '}
              <span className="quest">
                <span className="strong">[55] Cleansing Felwood</span>
              </span>
              .
            </p>
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/felwoodcircuit1.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[54] The Corruption of Jadefire</span>
              </span>{' '}
          ...
          <li>
            ...
            <span className="em">(43,67)</span>, to the west should be a green
            pool, go there and kill <span className="strong">Cursed Oozes</span>
          ...
          <li>
            ...
            <span className="em">(41,59)</span>, just a bit before Jaedenar, on
            the left side of the road is a small green pool with{' '}
            <span className="strong">tainted oozes</span>.{' '}
            <span className="em">Fill up 6 Tainted Ooze Jar</span>. If you lack
            oozes there is more just on the other side of the path leading to
            Jaedenar. Then go to Jaedenar <span className="em">(40,57)</span>,
            clear yourself a path westwards through Jadefire Hounds, Guardians,
            Adepts and Cultists until you get to the green pool at{' '}
            <span className="em">(35,60)</span>, then go back out of Jaedenar
          ...
          <li>
            ...
            <p>
              Ride north on the road until <span className="em">(42,69)</span>,
              which is just before the green pool where you killed the Cursed
              Oozes. Go west until you find{' '}
              <span className="strong">Satyrs</span> among the ruins{' '}
              <span className="em">(38,69)</span>. Kill whats on the kill list
              of{' '}
              <span className="quest">
                <span className="strong">
              ...
              . Shadowstalkers are stealthed but you can see them from far
              enough. Work your way westwards through the satyrs until you reach
              a green moonwell. <span className="strong">Xavathras</span> should
              be to the left of it with a guard. I killed the weak guard first
              quickly and then killed Xavathras. Use long cooldown abilities if
          ...
          <li>
            ...
            is complete, get back on the road, go north and then west back into
            Jaedenar, once again clear the way up to the Green pool where you
            already went to when you did{' '}
            <span className="quest">
              <span className="strong">[51] Forces of Jaedenar</span>
            </span>
            .<p></p>
            ...
            <p>
              ...
              and get the follow up{' '}
              <span className="quest">
                <span className="strong">[52] Seeking Spiritual Aid</span>
              </span>
              . Turn in{' '}
              <span className="quest">
                <span className="strong">[54] Corruption of the Jadefire</span>
              </span>{' '}
              and get{' '}
              <span className="quest">
          ...
          <li>
            ...
            falls. Shortly after the bridge go right into Shatter Scar Vale{' '}
            <span className="em">(39,44)</span>. Kill{' '}
          ...
          <li>
            ...
            <p>
              ...
              click it to get the quest{' '}
              <span className="quest">
                <span className="strong">[54] Flute of Xavaric</span>
              </span>
              .
            </p>
            <p></p>
          ...
          <li>
            ...
            until you get <span className="item">5 Jadefire Felbind</span> (they
            can drop from any of the 3 types of satyrs in Jadefire run) and
          ...
          <li>
            ...
            <p>
              ...
              path, sell and repair.
            </p>
            <p>
              Get back on the road and ride north until the entrance of
              Timbermaw Hold, talk to Nafien, turn in the quest. Get the other
              quest{' '}
              <span className="quest">
                <span className="strong">[55] Deadwood of the North</span>
              </span>
              .
            </p>
            <p>
              Go south on the road and at the first curve to the right make a
          ...
          <li>
            ...
            <span className="quest">
              <span className="strong">[55] Speak to Salfa</span>
            </span>
            . You should now no longer be attacked on sight by the Timbermaw
            Furlbogs.
          ...
          <li>
            ...
            bridge and to the north, keep going until you exit in Moonglade. In
            Moonglade go north straight to the shrine of Remulos{' '}
            <span className="em">(36,42)</span>, turn in{' '}
            <span className="quest">
              <span className="strong">[51] Seed of Life</span>
            </span>{' '}
          ...
          <li>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[50] The Mystery of Morrowgrain</span>
              </span>{' '}
          ...
          <li>
            ...
            <p>
              ...
              and get the follow up{' '}
              <span className="quest">
                <span className="strong">[52] Haze of Evil (Dungeon)</span>
              </span>
            </p>
            <p>
          ...
          <li>
            ...
            of Ravenwind. You should find Miblon Snarltooth left of the road
            infront of some small temple with no roof at{' '}
            <span className="em">(44,10)</span>. Place the bait on the floor
            infront of Miblon, the door behind him will open, quickly go and
            loot an evoroot. Now you should be{' '}
            <span className="em">
              <span className="strong">level 54</span>
            </span>{' '}
            or close. If you are not level 54, go west to the ruins of Ravenwind
            and grind on harpies until you ding. (
            <a href="http://www.wow-pro.com/node/569" className="bb-url">
              Remember to keep the Vibram Plumes from those harpies for the
        ...
        <ol className="bb-list">
          <li>
            Keep on grinding on those <span className="strong">harpies</span>{' '}
            until your hearthstone timer is almost reset (approximately 2
            minutes). Go back to Gregan, turn in the quest to get your{' '}
            <span className="item">3 Videre Elixir</span>. Use your hearthstone
            back to Auberdine, then fly to Darnassus and turn in the quest{' '}
            <span className="quest">
          ...
          <li>
            ...
            <p>
              ...
              and get the follow up{' '}
              <span className="quest">
                <span className="strong">[52] Meet at the Grave</span>
              </span>
          ...
          <li>
            ...
            , watch her summon a water elemental spirit and then take her follow
            up{' '}
            <span className="quest">
            ...
            <p>
              ...
              Dustwallow Marsh, then keep following the coast in Dreadmurk Shore
              until you arrive in Theramore Isle. Take a gryphon ride to
              Gadgetzan.
            </p>
            <p>
          ...
          <li>
            ...
            at the Broken Pillar <span className="em">(52,45)</span>, turn in{' '}
            <span className="quest">
              <span className="strong">[51] The Stone Circle</span>
            </span>
          ...
          <li>
            ...
            <p>
              ...
              (they drop from the Elder Diametradons approximately 25% drop
              chance)
              <br />
              <span className="quest">
                <span className="strong">
            ...
            <p>
              <span className="em">
                <span className="strong">Warning:</span>
              </span>{' '}
          ...
          <li>
            ...
            southern side in the middle <span className="em">(49,53)</span> then
            go a bit east to reach the cave where Ringo is{' '}
            <span className="em">(52,51)</span>. Turn in the quest{' '}
            <span className="quest">
              <span className="strong">[55] Lost!</span>
            </span>{' '}
            and get the follow up{' '}
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/xpratewintorat.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            <p>
              <span className="strong">Note:</span> This XP rate was just to
              show that with a proper quest path, you get great results even
              though there was a lot of travelling. This was done without any XP
              bonus.
            </p>
          ...
          <li>
            ...
            <ul className="bb-list">
              <li>
                ...
                and go to Sunken Temple, which I highly recommmend because we
        ...
        <ul className="bb-list">
          ...
          <li>
            ...
            <span className="quest">
              <span className="strong">A Little Slime Goes a long Way</span>
            </span>{' '}
        ...
        <ol className="bb-list">
          <li>
            ...
            <p>
              ...
              and{' '}
              <span className="quest">
                <span className="strong">[56] Starfall</span>
              </span>
              .{' '}
              <span className="em">
          ...
          <li>
            ...
            <p>
              ...
              at Arathandris Silversky <span className="em">(54,86)</span>. Talk
              to her and ask her for a Cenarion beacon. From now on when you
              kill stuff in Felwood you can get{' '}
              <span className="item">Corrupted Soul shards</span>, which you
              will turn in later for cenarion plant salves. With those salves
          ...
          <li>
            ...
            <span className="em">(51,82)</span>, turn in{' '}
            <span className="quest">
              <span className="strong">
            ...
            <p>
              ...
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[54] Felbound Ancients</span>
              </span>
              .<br />
              Turn in{' '}
              <span className="quest">
              ...
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[54] Silver heart</span>
              </span>
              .<br />
              Turn in{' '}
              <span className="quest">
          ...
          <li>
            ...
            <p>
              ...
              westwards until the green pool you already went to before to{' '}
              <span className="strong">fill up the vial</span>. Enter Shadow
              Hold <span className="em">(35,58)</span>.
            </p>
            <p>
          ...
          <li>
            ...
            Blood Red Key (the whole group can loot it if it drops),{' '}
            <span className="em">
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/feltowincircuit2.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/winterfeather.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[56] Winterfall Firewater</span>
              </span>
              .
            </p>
            <p></p>
          ...
          <li>
            ...
            <span className="em">(53,34)</span>. Go north to Starfall Village{' '}
            <span className="em">(51,30)</span>. Turn in{' '}
            <span className="quest">
              <span className="strong">[56] Starfall</span>
            </span>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/xpfeltoeverlook1.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <ul className="bb-list">
              <li>
                ...
                <span className="em">(55,43)</span>
              </li>
              <li>
                <span className="strong">The 3rd</span> is just west of it at{' '}
                <span className="em">(53,43)</span>
              </li>
              <li>
                <span className="strong">The 4th</span> one is directly north of
                the 3rd at <span className="em">(52,41)</span>
              </li>
              <li>
                <span className="strong">The 2nd</span> one is west of the 4th
                one at <span className="em">(51,41)</span>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <p>
              ...
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[56] Falling to Corruption</span>
              </span>
              .
            </p>
            <p>
              Ride north, back to Timbermaw Hold, go through it to Felwood. As
              soon as you exit in Felwood, jump down west in Felpaw Village.
        ...
        <ol className="bb-list">
          <li>
            ...
            <p>
              ...
              <span className="item">Cenarion Plant Salves</span> which you can
              use to cleanse corrupted plants in Felwood and get buffs or
              consumables from them.{' '}
              <a href="http://www.wow-pro.com/node/570" className="bb-url">
          ...
          <li>
            ...
            <p>
              ...
              Get the follow up{' '}
              <span className="quest">
                <span className="strong">[54] Aquementas</span>
              </span>
          ...
          <li>
            ...
            back, then you can kill each of the 4 warlocks one by one. When the
            room is clear, click on the Remains of{' '}
            <span className="strong">Trey Lightforge</span> on the altar, choose
            your reward and complete the quest{' '}
            <span className="quest">
              <span className="strong">[57] Retribution of the Light</span>
            </span>
            , get the follow up{' '}
            <span className="quest">
              <span className="strong">
          ...
          <li>
            ...
            <p>
              This part of the dungeon is just much easier with a group, you can
          ...
          <li>
            ...
            <span className="quest">
              <span className="strong">[58] A Final Blow</span>
            </span>{' '}
            and{' '}
            <span className="quest">
              <span className="strong">
            ...
            . Ride to Ashenvale. When in Ashenvale follow the road south and
            then east towards Azshara, make a stop at Forest song which is just
            east of Satyrnaar. Turn in{' '}
            <span className="quest">
              <span className="strong">[56] Ancient Spirit</span>
            </span>{' '}
          ...
          <li>
            ...
            <p>
              ...
              Timbermaw entrance to the crossroads, then they go around the
              mountain by the north and to Winterfall Village.
            </p>
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/wtfrunnersroute.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/xpfeltoeverlook2.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/wintertodarnacircuit.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            ...
            <p>
              ...
              <span className="em">(66,33)</span>, kill{' '}
              <span className="strong">8 Winterfall Shamans</span> and{' '}
              <span className="strong">8 Winterfall Ursa</span> there.
            </p>

            <p>
              Once that is done, go south over the mountain to Ice Thistle Hills{' '}
              <span className="em">(65,41)</span>. Kill{' '}
              <span className="strong">Ice Thistle Yetis</span> there until you
          ...
          <li>
            ...
            <p>
              ...
              . Then she will go to the altar of elune, which you will have to
              click too. Then a beautiful scene will happen and you will have
              the quest complete message at the end of it.
            </p>
            <p>
          ...
          <li>
            ...
            and get the follow up. Sell, repair and resupply food/drink. Go
            east/southeast of Everlook back to Ice Thistle Hills, this time
            enter the cave further to the east up the hills{' '}
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[58] Are We There, Yeti?</span>
              </span>{' '}
          ...
          <li>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[57] Wildkin of Elune</span>
              </span>
              . Go back inside Darnassus to Arch Druid Staghelm at the Cenarion
              Enclave and turn in the quest.
            </p>
            <p>
              <span className="strong">
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/xpeverlooktodarna.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <span className="em">
              You can put your cenarion beacon and any Corrupted Soul Shard or
              Cenarion Plant Slave at the bank
            </span>
        ...
        <ol className="bb-list">
          ...
          <li>
            ...
            <p>
              In Ironforge, sell/repair, resupply food and drink (4 stacks),
              check the AH.
              <br />
              Go to the throne room and take the quest{' '}
              <span className="quest">
                <span className="strong">[54] The Smoldering Ruins</span>
              </span>{' '}
              of Thaurissan from Royal Historian Archesonus, then talk to her
              again and go through her dialogue. Turn in the quest and get the
              follow up.
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/bsteppescircuit.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            <ul className="bb-list">
              <li>Get the flight path.</li>
              <li>
                Get the quests{' '}
                <span className="quest">
              ...
              <li>
                Get{' '}
                <span className="quest">
                  <span className="strong">[54] Dragonkin Menace (Elite)</span>
                </span>{' '}
          ...
          <li>
            ...
            <p>
              ...
              get{' '}
              <span className="quest">
                <span className="strong">[52] Broodling Essence</span>
              </span>{' '}
          ...
          <li>
            ...
            <p>
              ...
              which is north of Dreadmaul Rock{' '}
              <span className="em">(78,28)</span>, you should find{' '}
              <span className="strong">Black Broodlings</span> there. Search
              your inventory for{' '}
              <span className="item">Draco-Incarcinatrix 900</span> and put it
              ...
              Take his quest{' '}
              <span className="quest">
                <span className="strong">[54] A Taste of Flame</span>
              </span>
              , talk to him and click on the dialogue line, then turn in the
              quest, get the follow up{' '}
              <span className="quest">
                <span className="strong">[58] A Taste of Flame (Dungeon)</span>
              </span>
              .
            </p>
          ...
          <li>
            ...
            , get the follow up{' '}
            <span className="quest">
              <span className="strong">[54] Felnok Steelspring</span>
            </span>
            . Turn in{' '}
            <span className="quest">
              <span className="strong">[50] Tablet of the Seven</span>
          ...
          <li>
            ...
            <p>
              ...
              at Highlord Bolvar Fordragon and get the follow up. Also get the
              other quest{' '}
              <span className="quest">
                <span className="strong">
            ...
            <p>
              Talk to Lady Katrana Prestor who is right next to Bolvar, go
              through her dialogue then turn in the quest at Highlord Bolvar and
              get the follow up{' '}
              <span className="quest">
                <span className="strong">[54] The True Masters.</span>
              </span>
            ...
            <p>
              Turn in the quest{' '}
              <span className="quest">
                <span className="strong">[62] The First and the last</span>
              </span>
              , get the follow up, turn it in and get the follow up{' '}
              <span className="quest">
                <span className="strong">[62] Flint Shadowmore.</span>
              </span>
            </p>
          ...
          <li>
            ...
            <p>
              <span className="em">Note:</span> I got delayed a lot because
              someone was doing the onyxia key quest where a bunch of elite
          ...
          <li>
            ...
            <p>
              Fly to Aerie Peak, follow the road southwest to Hillsbrad
              Foothills, then go west/northwest along the mountain until you hit
              the river. Follow the river north towards Chillwind Point, then go
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/plaguelandscircuit1.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            ...
            <p>
              ...
              and get the follow up{' '}
              <span className="quest">
                <span className="strong">[62] The Eastern Plagues</span>
              </span>
              .<br />
              Get{' '}
              <span className="quest">
                <span className="strong">[52] Clear the Way</span>
              </span>{' '}
              from Commander Ashlam.
              <br />
              Turn in{' '}
              <span className="quest">
                <span className="strong">[52] The Everlook Report</span>
              </span>{' '}
              from Aregent Officer Pureheart, also complete the quest{' '}
              <span className="strong">Argent Dawn Commission</span>, you will
              receive a trinket.
              <br />
              When you kill undeads while having this trinket equiped, you can
              collect{' '}
              <span className="em">
                <span className="strong">Scourgestones</span>
              </span>{' '}
              from their bodies. I suggest equiping it from now on everytime you
              kill undeads in{' '}
              <span className="em">eastern and western plaguelands</span>.
            </p>

            <p>
              Turning in these Scourgestones at Argent Officer Pureheart gets
              you <span className="strong">faction increases</span> with the
              Argent Dawn and a token. These tokens are the only way to raise
              your faction with the Argent Dawn at a certain point in reverred,
              so save them until then.{' '}
              <a
          ...
          <li>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[53] The Scourge Cauldrons</span>
              </span>{' '}
              and{' '}
              <span className="quest">
                <span className="strong">[56] All Along the Watchtowers</span>
              </span>
              .
            </p>
            <p>
              ...
              . Get the follow up{' '}
              <span className="quest">
                <span className="strong">[53] Target: Felstone Field</span>
              </span>
              .
            </p>
            <p>
              Go back through Sorrow Hill and enter the Ruins of Andorhal by the
              south gate <span className="em">(49,73)</span>.
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              when you get close,{' '}
              <span className="strong">Cauldron Lord Bilemaw</span> will spawn,
              kill it and loot the{' '}
              <span className="item">Felstone Field Cauldron Key</span> from
              him, then go to the cauldron and click it, turn in the quest and
              get the follow up{' '}
              <span className="quest">
                <span className="strong">[53] Return to Chillwind Camp.</span>
              </span>
            </p>
            <p>
              In the Felstone Field, go to the houses on the north side of the
              field, enter the one which is the most to the west{' '}
          ...
          <li>
            ...
            <p>
              You can find the <span className="strong">Scarlets Knights</span>{' '}
              and <span className="strong">Mages</span> you need to kill for the
              quest just southeast of Kirsta, on the road to Hearthglen. For the{' '}
              <span className="strong">Hunters</span> and{' '}
              <span className="strong">Medics</span> go to the camp further
              south and to the east <span className="em">(51,44)</span>.
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              Radley <span className="em">(57,35)</span>. She can be pulled solo
              if you wait for the right moment: when the mage close to her goes
              far enough.
            </p>
            <p>
              Get back on the main road and this time at the fork go left, keep
              going north until you hit the watch tower{' '}
          ...
          <li>
            ...
            going southwest and jumping down in the crater where she is. Turn in
            the quest{' '}
            <span className="quest">
            ...
            <p>
              ...
              <span className="strong">Scarlet Dudes</span> or{' '}
          ...
          <li>
            ...
            City Hall <span className="em">(48,32)</span> on the 2nd floor. Turn
            in{' '}
            <span className="quest">
              <span className="strong">[52] Better Late Than Never.</span>
            </span>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[52] Good Natured Emma</span>
              </span>
              . Get the follow up{' '}
              <span className="quest">
                <span className="strong">[52] Good Luck Charm</span>
              </span>
              .<br />
              <span className="strong">
                <br />
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/xpplaguelands1.jpg"
                alt=""
                className="bb-image"
              />
            </p>
        ...
        <ol className="bb-list">
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/plaguelandscircuit2a.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            <p>
              ...
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[55] Target: Writhing Haunt</span>
              </span>
              .
            </p>
            <p></p>
          ...
          <li>
            ...
            <span className="em">(38,54)</span> on the 2nd Floor. Turn in the
            quest{' '}
            <span className="quest">
              <span className="strong">[52] Good Luck Charm</span>
            </span>{' '}
          ...
          <li>
            ...
            <span className="em">(49,56)</span> where a trail crosses the road.
            Go south following the trail to the Writhing Haunt{' '}
          ...
          <li>
            ...
            <p>From now on, kill on sight the following:</p>
            <ul className="bb-list">
              <li>
                <span className="strong">Plaguehound Runt</span>
              </li>
              <li>
                <span className="strong">Carrion Worm</span>
              </li>
              <li>
                <span className="strong">Plaguebat</span>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <p>
              ...
              the quest{' '}
              <span className="quest">
                <span className="strong">[55] Sister Pamela</span>
              </span>{' '}
              and get the follow up{' '}
              <span className="quest">
          ...
          <li>
            ...
            <p>
              ...
              <span className="strong">30 Plaguebat</span> and{' '}
              <span className="strong">20 Plaguehound Runts</span> slain. This
          ...
          <li>
            ...
            <p>
              Get the flight path. Turn in{' '}
              <span className="quest">
                <span className="strong">[52] Duke Nicholas Zverenhoff</span>
              </span>
              . Turn in{' '}
              <span className="quest">
                <span className="strong">[56] Uncle Carlin</span>
              </span>
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[55] Defenders of Darrowshire</span>
              </span>
              .
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[62] The Blightcaller Cometh</span>
              </span>
              .
            </p>
            <p></p>
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/xpplaguelands2.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <p>
              <span className="strong">The 4 Relic Fragments.</span>
            </p>
            <p>
              Fly to Chillwind Camp. Get the quest{' '}
              <span className="quest">
                <span className="strong">[55] A Plague Upon Thee</span>
              </span>{' '}
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/plaguelandscircuit3a.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            ...
            <p>
              Ride east to Sorrow Hill and find Marlene Redpath in the only
              house there is <span className="em">(49,78)</span>.
            </p>

            <p>
              Turn in{' '}
              <span className="quest">
                <span className="strong">[56] Auntie Marlene</span>
              </span>{' '}
              and get the follow up{' '}
              <span className="quest">
                <span className="strong">[56] A Strange Historian (Elite)</span>
              </span>
              .
            </p>
          ...
          <li>
            ...
            <p>
              ...
              the follow up{' '}
              <span className="quest">
                <span className="strong">[56] The Annals of Darrowshire</span>
              </span>
              . Also ge the other quest{' '}
              <span className="quest">
                <span className="strong">[56] A Matter of Time</span>
              </span>
              .
            </p>
            <p></p>
          ...
          <li>
            ...
            <p>
              ...
              <span className="item">Temporal Displacer</span> (looks like a
              horn).{' '}
              <span className="strong">
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/smalllockbox.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <p>
              ...
              lightbrown and white, like this one:{' '}
            </p>
            <p>
              <img
            ...
            <p>
              You can easily see the difference if you zoom in 1st person view
          ...
          <li>
            ...
            . <span className="item">The Attuned Dampener</span> you get as a
          ...
          <li>
            ...
            <p>
              Turn in{' '}
              <span className="quest">
                <span className="strong">[56] Demon Dogs</span>
              </span>
              ,{' '}
              <span className="quest">
                <span className="strong">[56] Blood Tinged Skies</span>
              </span>{' '}
              and{' '}
              <span className="quest">
                <span className="strong">[56] Carion Grubbage</span>
              </span>
              . Get the follow up{' '}
              <span className="quest">
          ...
          <li>
            ...
            <p>
              ...
              <br />
              They all hit hard, especially Mercutio, and all have a lot of hit
              points for non elites. Here is what I suggest:
            </p>
            <p>
              As soon as you click the dirt mount, run to the other side of the
              fence, you can jump over it if you walk up the mountain a bit. The
              4 dwarves will walk to the grave and stand there.
            </p>
            <p>
              <span className="em">You have two ways to do this now:</span>
            </p>
            <p>
              <span className="strong">1.</span>{' '}
              <span className="em">Polymorph Mercutio</span> (if you have a mage
              with you) and kill the{' '}
              <span className="strong">3 gravediggers</span>. Then bandage up
              and kill Mercutio, loot his hammer.
            </p>
            <p>
              <span className="strong">2.</span> Ignore the 3 adds and go all
              out on Mercurio, loot the hammer and run.
            </p>
            <p>
              <span className="em">
            ...
            <p>
              <span className="strong">Ex:</span> With my rogue I got help from
            ...
            <p>
              ...
              , grind on the trolls in the Undercroft while waiting for someone
              to help you. It just takes 10 min! Call a guildmate or something.{' '}
              <img
          ...
          <li>
            ...
            <span className="quest">
              <span className="strong">[56] Of Forgotten Memories</span>
            </span>
            , get the follow up{' '}
            <span className="quest">
            ...
            <p>
              ...
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[57] Villains of Darrowshire</span>
              </span>{' '}
              and{' '}
              <span className="quest">
                <span className="strong">[56] Heroes of Darrowshire.</span>
              </span>
              <br />
              Turn in{' '}
              <span className="quest">
        ...
        <ol className="bb-list">
          <li>
            ...
            <p>and loot them.</p>
            <p>
              Kill stuff inside plaguewood while looking for those termite
              mounds, but also try to find as much{' '}
              <span className="strong">Cannibal Ghouls</span> as possible.
              Anytime you kill one of these, a Spirit of Darrowshire will
              appear, right click it to free it. You need to free{' '}
              <span className="strong">15 Darrowshire Spirits</span>. The
              Cannibal Ghouls are not so numerous though, so it will take a
              while, consider this as a mini grinding session, plus you are
          ...
          <li>
            ...
            <p>
              Clear some of the trolls until you get a clear pull on Hameya,
          ...
          <li>
            ...
            <p>
              ...
              and get the follow up{' '}
              <span className="quest">
                <span className="strong">[58] Of Love and Family</span>
              </span>
              .
            </p>
          ...
          <li>
            ...
            Darrow, find Artist Renfray in a wooden house{' '}
            <span className="em">(65,75)</span>. Turn in{' '}
            <span className="quest">
              <span className="strong">[58] Of Love and Family</span>
            </span>{' '}
            and get the follow up{' '}
            ...
            <p>
              ...
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[57] Mold Rhymes With...</span>
              </span>
            </p>
            <p>
              This is for your{' '}
              ...
              from Commander Ashlam Valorfist when you go kill Araj for your
              Scholomance Key quest - killing two birds with one stone.
            </p>
            <p>
              Turn in{' '}
              <span className="quest">
          ...
          <li>
            ...
            Camp. Go straight to the lumber mill which is at the northeastern
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/xpplaguelands3.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <p>
              ...
              Also get{' '}
              <span className="quest">
                <span className="strong">[59] Kharan Mighthammer</span>
              </span>{' '}
              from King Magni Bronzebeard while you are here.
            </p>
            <p>
              Go to Auberdine, fly to Everlook, Winterspring. (or ask a mage to
              teleport you to Darnassus, then fly to auberdine --&gt; everlook).
            </p>
            <p>
              In Everlook, turn in{' '}
              <span className="quest">
            ...
            <p>
              ...
              , get the follow up{' '}
              <span className="quest">
                <span className="strong">[54] Chillwind Horns</span>
              </span>
              .
            </p>
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/wintercircuit.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            Rock on the map. You will find{' '}
            <span className="strong">Chillwind Ravagers</span> and{' '}
          ...
          <li>
            ...
            <p>
              ...
              <span className="quest">
                <span className="strong">[60] An Earnest Proposition</span>
              </span>{' '}
              at Deliana and get your Dungeon Set 1 bracers updated!{' '}
              <span className="strong">3 Spectral stalkers</span> (non elite)
              will spawn and attack Deliana, help her to kill them. <br />
              Get the follow up{' '}
              <span className="quest">
          ...
          <li>
            ...
            <p>
              Doing Blackrock Depths and all the quests should easily ding you
              60, and some of these quests are important for your level 60 life:
            </p>
            <ul className="bb-list">
              <li>
                <span className="quest">
                  <span className="strong">[60] Attunement to the Core:</span>
                </span>{' '}
              ...
              <li>
                <span className="quest">
                  <span className="strong">[54] Marshall Windsor</span>
                </span>
          ...
          <li>
            ...
            <p>
              ...
              get the follow up{' '}
              <span className="quest">
                <span className="strong">[57] Fire Plume Forged.</span>
              </span>
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              Get{' '}
              <span className="quest">
                <span className="strong">[55] Securing the Supply Lines</span>
              </span>{' '}
              from Windcaller Proudhorn.{' '}
              <span className="quest">
                <span className="strong">[55] Deadly Desert Venom</span>
              </span>
              , from Beetix Fickelspragg on the 1st Floor of the Inn.
              <br />
              <span className="quest">
                <span className="strong">[58] The Twilight Mystery</span>
              </span>{' '}
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/silithuscircuit.jpg"
                alt=""
                className="bb-image"
              />
            </p>
          ...
          <li>
            ...
            <p>
              ...
              and{' '}
              <span className="quest">
                <span className="strong">[55] Securing the Supply</span>
              </span>{' '}
              lines.
            </p>
            <p>
            ...
            <p>
              ...
              <span className="item">Twilight Cultist Robe</span>,{' '}
              <span className="item">Mantle</span> and{' '}
              <span className="item">Cowl.</span>
            </p>
            <p>
              Keep them, you will need them later on for level 60 faction quests
              with cenarion.
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              <img
                src="http://www.wow-pro.com/files/guidepics/twilightfragment.jpg"
                alt=""
                className="bb-image"
              />
            </p>
            <p>
              As soon as you have <span className="item">8 tablets</span>, go
              southeast towards Cenarion Hold, kill every Dredge Crusher on the
              way so that you finish{' '}
              <span className="quest">
                <span className="strong">[57] Stepping Up Security</span>
              </span>
              .
          ...
          <li>
            ...
            Ironforge, fly to Chillwind Camp, turn in{' '}
            <span className="quest">
              <span className="strong">[57] Fire Plume Forged</span>
            </span>
            , get the follow up{' '}
